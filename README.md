...
[![GoDoc](https://godoc.org/github.com/maxposter/telebot?status.svg)](https://godoc.org/github.com/maxposter/telebot)
...
```bash
go get -u github.com/maxposter/telebot
```
...
[here](https://godoc.org/github.com/maxposter/telebot#pkg-constants).
