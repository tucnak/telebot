...
[![GoDoc](https://godoc.org/github.com/maxbolgarin/telebot/v4?status.svg)](https://godoc.org/github.com/maxbolgarin/telebot/v4)
...
```bash
go get -u github.com/maxbolgarin/telebot/v4
```
...
[here](https://godoc.org/github.com/maxbolgarin/telebot/v4#pkg-constants).
...
implementations:
```go
import "github.com/maxbolgarin/telebot/v4/middleware"
```
...
[here](https://pkg.go.dev/github.com/maxbolgarin/telebot/v4#Option).
