...
[![GoDoc](https://godoc.org/github.com/maxposter/telebot.v2Maxposter?status.svg)](https://godoc.org/github.com/maxposter/telebot)
...
```bash
go get -u github.com/maxposter/telebot.v2Maxposter
```
...
[here](https://godoc.org/github.com/maxposter/telebot.v2Maxposter#pkg-constants).
